...
```
npm install @rakuten-rex/react-component-starter-kit@3.2.3 --save
```

<img src="project-scripts/webpack/markdown/logos/yarn.svg?sanitize=true" height="16" />

```
yarn add @rakuten-rex/react-component-starter-kit@3.2.3
```
...
```
https://unpkg.com/@rakuten-rex/react-component-starter-kit@3.2.3/MyComponent/MyComponent.production.min.css
```
...
```
https://unpkg.com/@rakuten-rex/react-component-starter-kit@3.2.3/MyComponent/MyComponent.development.css
```
...
```
https://unpkg.com/@rakuten-rex/react-component-starter-kit@3.2.3/MyComponent/MyComponent.static.css
```
...
<html>
  <head>
    ...
    <link href="https://unpkg.com/@rakuten-rex/react-component-starter-kit@3.2.3/MyComponent/MyComponent.production.min.css" rel="stylesheet">
  </head>
  <body>
    <div class="rex-my-component" role="presentation">
      <img src="static/media/Image.jpg" alt="Basic example" style="width:100%" />
