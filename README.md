...
```
npm install @rakuten-rex/react-component-starter-kit@3.2.0 --save
```

<img src="project-scripts/webpack/markdown/logos/yarn.svg?sanitize=true" height="16" />

```
yarn add @rakuten-rex/react-component-starter-kit@3.2.0
```
...
```
https://unpkg.com/react-component-starter-kit@3.2.0/react-component-starter-kit.production.min.css
```
...
```
https://unpkg.com/react-component-starter-kit@3.2.0/react-component-starter-kit.development.css
```
...
```
https://unpkg.com/react-component-starter-kit@3.2.0/react-component-starter-kit.static.css
```
...
<html>
  <head>
    ...
    <link href="https://unpkg.com/react-component-starter-kit@3.2.0/react-component-starter-kit.production.min.css" rel="stylesheet">
  </head>
  <body>
    <div class="rex-my-component" role="presentation">
      <img src="static/media/Image.jpg" alt="Basic example" style="width:100%" />
